...
- Spring Boot & FastAPI microservices (15K+ DAUs, 99.8% uptime)

- AI/ML pipelines ( contributor: [Haystack AI](https://github.com/deepset-ai), [Jenkinsci](https://github.com/jenkinsci/resources-ai-chatbot-plugin), [Accomplish AI](https://github.com/accomplish-ai/accomplish) )

- Agent systems (Top 50/57K at Google Cloud Agentic AI Day)
